...
existingmodulename="github.com/anukuljoshi/goweb"
modulename=''
a_flag=false

# https://github.com/bnkamalesh/goapp/blob/master/makeitmine.sh
print_usage() {
  printf """
Usage:
...
-a    Optional flag if set, will do the following:
        ...
        - empty README.md
        - remove .travis.yml
-e    Optional parameter accepts an existing module name to be replaced. Default is 'github.com/anukuljoshi/goweb'
